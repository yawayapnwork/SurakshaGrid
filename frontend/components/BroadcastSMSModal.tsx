...
export const BroadcastSMSModal: React.FC<BroadcastSMSModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 animate-fade-in">
      <div className="bg-white border border-slate-200/80 rounded-2xl max-w-md w-full p-6 text-slate-900 shadow-lg space-y-5">
        {/* Modal Header */}
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div className="flex items-center gap-2 text-slate-500">
            <MessageSquareWarning className="w-4.5 h-4.5" />
            <h3 className="font-semibold text-[15px] text-slate-900 tracking-tight">Broadcast SMS Alert</h3>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 focus:border-slate-400 rounded-xl p-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400 transition-all font-mono"
          />
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            maxLength={1600}
            className="w-full bg-white border border-slate-200 focus:border-slate-400 rounded-xl p-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400 transition-all resize-none"
          />
        </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-1">
          <button
            onClick={handleClose}
            className="px-4 py-2 rounded-lg bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-semibold text-xs transition-all"
          >
            Cancel
          </button>
          <button
            ...
            className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold text-xs flex items-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
